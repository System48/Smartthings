...
def request(body) { 
    ...
    def cmds = []
    def action = new physicalgraph.device.HubAction(body,physicalgraph.device.Protocol.LAN, "$hosthex:$porthex")
...
/*   
    def ip = "255.255.255.255:31415"
    def deviceNetworkId = "$hosthex:$porthex"
    def x = new physicalgraph.device.HubAction("${body}\r\nHOST: $ip\r\n\r\n", physicalgraph.device.Protocol.LAN)
